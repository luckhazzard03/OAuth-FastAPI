...
# # ---- Modulo Orders con Autenticación ---- #
# orders_router = APIRouter(tags=["Orders"])

# # Ruta para autenticación en el módulo de órdenes
# @orders_router.post("/auth", summary="Orders Authentication")
...
# # Rutas protegidas del módulo de órdenes
